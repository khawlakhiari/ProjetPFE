        ...
        <div class="col-sm-12" style="padding-left: 0; padding-right: 0; padding-top: 50px;">
            ...
            <div class="row">
                <div class="col-md-8 col-12 mr-3">
                    <div class="row">
                        <form method="post" action="{{route('baccalauriat')}}">
                            {{csrf_field()}}
                            <div class="col-md-12 form-group">
                                <label class="creditcardtext" >Année du bac <span style="color:red"> * </span></label>

                                <input type="text" class="form-control" id="nom" name="anne_bac"  required>
                            </div>
                            <div class="col-md-12 form-group" >
                                <label class="creditcardtext">Baccalauriat <span style="color:red"> * </span></label>

                                <select id="select" name="master" class="custom-select" style="margin-top: 1px">
                                    <option value="sexe">Mathématiques</option>
                                    <option value="sexe">Sciences expérimentales </option>
                                    <option value="sexe">Économie et gestion </option>
                                    <option value="sexe">Sciences techniques </option>
                                    <option value="sexe">Lettres </option>
                                    <option value="sexe">Sport </option>
                                    <option value="sexe">Sciences informatiques </option>
                                </select>
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="creditcardtext" >Image de baccalauriat <span style="color:red"> * </span></label>

                                <input type="file" class="form-control" id="nom" name="anne_bac"  required style="padding:5px">
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="creditcardtext" >Charger votre image:<span style="color:red"> * </span></label>
